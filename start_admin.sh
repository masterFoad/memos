#!/bin/bash
# Start OnMemOS v3 Admin Server with conda activation

set -e

echo "🚀 Starting OnMemOS v3 Admin Server..."
...
echo "📋 Admin endpoints: http://localhost:8001/admin/docs"
echo "🔐 Internal API Key required for all endpoints"
